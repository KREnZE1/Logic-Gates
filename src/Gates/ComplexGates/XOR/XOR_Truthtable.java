...
public class XOR_Truthtable {
    ...
    XOR_Gate xorGate; //The tested Gate
    ...
    public void inFalseFalse() {
        ...
        //Two false values create a false value when fed into the logical NAND-Gate
    ...
    public void invalidIndex() {
        ...
        try {
            xorGate.setInput(o1, 2); //A wrong index should lead to an Exception being thrown
    ...
    public void inputOneNotSet() {
        ...
        xorGate.setInput(o2, 1);
        try {
            xorGate.calcOutput(); //If an index was not set before the output is calculated an Exception should be thrown
